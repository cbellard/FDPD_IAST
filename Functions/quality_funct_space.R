...
#(mat_pcoa$values$Eigenvalues[1]/sum(mat_pcoa$values$Eigenvalues))*100
# mat_pcoa$values$Relative_eig[1]*100
#https://www.researchgate.net/post/How_to_calculate_the_explained_variance_per_factor_in_a_principal_axis_factor_analysis
